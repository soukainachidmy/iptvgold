    ...
    <>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Featured Post */}
          <Link href={`/blog/${featured.slug}`} className="card-hover block bg-[#111118] border border-[#1e1e2e] rounded-2xl overflow-hidden mb-12 group">
            <div className="grid lg:grid-cols-2 gap-0">
              <div className="h-64 lg:h-auto bg-gradient-to-br from-[#0d1a3a] to-[#0f2247] flex items-center justify-center p-12">
              ...
              <div className="p-8 lg:p-10">
                ...
                <h2 className="text-2xl lg:text-3xl font-extrabold text-white mb-3 group-hover:text-[#3b8ef3] transition-colors">
                  {featured.title}
                </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {rest.map((post) => (
              <Link key={post.slug} href={`/blog/${post.slug}`} className="card-hover bg-[#111118] border border-[#1e1e2e] rounded-2xl p-8 group">
                ...
                <h3 className="text-lg font-bold text-white mb-3 group-hover:text-[#3b8ef3] transition-colors">
                  {post.title}
                </h3>
